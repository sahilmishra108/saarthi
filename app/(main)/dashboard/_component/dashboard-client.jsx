  ...
  return (
    <>
      <div className="mb-6 sm:mb-8 text-center" data-aos="fade-up">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold mb-3 sm:mb-4">
          <span className="bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">Industry Insights</span>
        </h1>
        <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white max-w-2xl mx-auto px-2">
